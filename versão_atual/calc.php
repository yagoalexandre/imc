...
<header>
    <?php 
        ...
        elseif ($imc > 30.0 and $imc < 34.9) {
            echo"<h1>Você está está com obesidade, talvez seja melhor procurar um nutricionista e começar uma dieta.</h1>";
        }
        elseif ($imc > 34.9 and $imc < 39.8) {
            echo"<h1>Você está em um grau servero de obesidade, talvez deva procurar ajudar médica.</h1>";
        }
        elseif ($imc > 40.0) {
            echo"<h1>Você está com sérios riscos a sua saúde, procure por ajuda assim que possível.</h1>";
        }
